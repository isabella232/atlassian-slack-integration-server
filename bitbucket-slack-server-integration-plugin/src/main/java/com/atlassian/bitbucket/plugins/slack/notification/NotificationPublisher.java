...
public class NotificationPublisher {
    ...
    private void notify(final Collection<ExtendedChannelToNotify> channelsToNotify,
        ...
        channelsToNotify.forEach(channel -> {
            ...
            messageProvider
                    .apply(new NotificationRenderingOptions(verbosity, channelToNotify.isPersonal(), channel.getUserId()))
                    .ifPresent(message -> {
    ...
    private Set<ExtendedChannelToNotify> getChannelsToNotify(final Repository repository,
        ...
        return channels.stream()
                .map(channel -> new ExtendedChannelToNotify(channel, notificationTypeKey, Optional.empty()))
